...
#define MAX_FILE_LEN 214 /**< Максимална дужина имена датотеке у Windows-у */
 ...
 *
 * Додаје #CRYPT_TEXT на крај имена шифроване датотеке @p inFileName. Ако је име датотеке које би се добило веће од максималне дужине имена датотеке коју 
 * @c WINDOWS може да прими (#MAX_FILE_LEN), на крај имена додаје #CRYPT_TEXT преко онолико карактера колико треба да се дода #CRYPT_TEXT, 
 ...
 * док дато име не буде постојало. Кад дужина имена са додатим насумичним бројем пређе дужину #MAX_FILE_LEN 
 ...
 * @return @c 0 aко је све добро протекло.\n
		   ...
		   @c 2 ако је првобитно прослеђено име веће од #MAX_FILE_LEN
 * @code{.c}
